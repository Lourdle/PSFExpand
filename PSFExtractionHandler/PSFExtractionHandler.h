...
typedef struct _PSFEXTHANDLER_UTIL_CABEXPANSIONPROGRESS
{
	...
	FILETIME FileTime;
}PSFEXTHANDLER_UTIL_CABEXPANSIONPROGRESS, * PPSFEXTHANDLER_UTIL_CABEXPANSIONPROGRESS;

typedef VOID(*PSFEXTHANDLER_UTIL_CABEXPANSIONPROGRESSCALLBACK)(PSFEXTHANDLER_UTIL_CABEXPANSIONSTATE, const PSFEXTHANDLER_UTIL_CABEXPANSIONPROGRESS*, PHANDLE, PVOID);

PSFEXTRACTIONHANDLER_API
BOOL PSFExtHandler_util_ExpandCabinet(
	HANDLE hCabinet,
	PSFEXTHANDLER_UTIL_CABEXPANSIONPROGRESSCALLBACK pfnProgressCallback,
	PVOID pvUserData
);
